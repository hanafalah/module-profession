...
namespace Hanafalah\ModuleProfession\Facades;
 ...
 */
class ModuleProfession extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModuleProfession\Contracts\ModuleProfession::class;
  }
}
